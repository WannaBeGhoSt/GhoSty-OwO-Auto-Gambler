...
A Python-based Discord self-bot that is focused on OwO Bot's Gamble Automation.  

## 🚀 Features  

- 🚨 **No Guarantee** - The Author Does Not Guarantee Any Continuous Wins Or Loop Holes To Win Again And Again In The Gambling.
- 🔄 **Automation** - Automates OwO's CoinFlip For Gambling OwO Cash.
- ⚡ **Fast & Secure** – Optimized for speed and security.
- 🎭 **Multi Token Support** - Can be used on multiple accounts at once.

## 📖 Installation & Usage  

### 1️⃣ Setup  

- Add your **Main ID Discord token** in the config.json.  
- Add your **Worker Account Tokens** in the tokens.txt.  
- Ensure you have Python (>3.10 and <3.12) installed on your system.  
